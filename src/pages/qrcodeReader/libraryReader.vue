          ...
          <div
           ...
           >
            <div class="text-h4 text-bold text-white">
              Welcome to CKCM Library <img style="height:40px" src="https://loading.io/s/icon/e7vtp5.svg" alt="">
            </div>
        ...
        <q-card
         ...
         >
          ...
          <q-card-section class="row wrap">
            ...
            >
              <img src="https://www.emoji.com/wp-content/uploads/filebase/icons/emoji-icon-glossy-00-00-faces-face-positive-face-with-bright-idea-but-ahndless-72dpi-forPersonalUseOnly.png" alt="">
            </q-avatar>
            <div class="col">
              <span class="text-white text-h6">Question: </span> <br>
              <span
                class="text-white text-h5 text-weight-bold"
