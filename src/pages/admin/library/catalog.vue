    ...
    catalogInfo: {
      ...
      accessionNumber: {
        isUnique (value) {
          ...
          forEach(vm.listofCatalog, function (data) {
            forEach(data.accessionNumber, function (val) {
              listofAccession[val] = val
            })
          })
          forEach(value, function (val) {
            forEach(vm.dummycatalogInfo, function (dummyVal) {
              if (dummyVal) {
                result = true
              } else {
                listofValue.push(val)
                oneValue = listofAccession[val]
                if (oneValue) {
                  result = false
                } else {
                  result = true
