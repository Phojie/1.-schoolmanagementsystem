          ...
          <div class="col-xs-12 row q-col-gutter-md">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <q-select
                dense
                outlined
                :value="dataInformation.department"
                @input="$emit('update:department', $event)"
                :options="['College of Education','College of Computer Science', 'College of Criminology', 'College of Business Administration']"
                label="Department"
                class="text-capitalize "
                :error="validations.department.$error"
                hide-bottom-space
              >
                <template
                  v-slot:error
                  v-if="!validations.department.required"
                >
